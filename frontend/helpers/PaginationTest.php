    ...
    public function getPagination($arr_params) {
        ...
        if($total_page == 1) {
            ...
            for($page = 1; $page <= $total_page; $page++) {
                if(isset($title)) {
                    $url_page = "index.php?controller=$controller&action=$action&title=$title&page=$page";
                } else if (isset($category)) {
                    $url_page = "index.php?controller=$controller&action=$action&category=$category&page=$page";
                }
                else {
