...
class Product extends Model
{
    ...
    public function insert()
    {
        $obj_insert = $this->connection
            ->prepare("INSERT INTO products(category_id, title, avatar, price, amount, summary, content) 
                                VALUES (:category_id, :title, :avatar, :price, :amount, :summary, :content)");
        $arr_insert = [
    ...
    public function update($id)
    {
        $obj_update = $this->connection
            ...
            summary=:summary, content=:content, updated_at=:updated_at WHERE id = $id
");
        $arr_update = [
            ':category_id' => $this->category_id,
            ':title' => $this->title,
