...
//            'query_additional' => $query_additional,
        ...
        $pagination_test = new PaginationTest($arr_params);
        $pages = $pagination_test->getPagination($arr_params);
        //lấy danh sách category đang có trên hệ thống để phục vụ cho search
        $category_model = new Category();
        $categories = $category_model->getAll($str_search);
    ...
    {
        $this->page_title = "Create Product";
        //xử lý submit form
    ...
    {
        $this->page_title = "Product Detail";
